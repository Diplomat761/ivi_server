...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "user@mail.com", description: "Почтовый адрес" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "root123", description: "Пароль" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "password", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "true", description: "Наличие бана" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN, defaultValue: false }),
    __metadata("design:type", Boolean)
], User.prototype, "banned", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Спам-рассылка", description: "Причина бана" }),
...
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => profiles_model_1.Profile),
    __metadata("design:type", Array)
