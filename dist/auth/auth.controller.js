...
const Vk_auth_guard_1 = require("./utils/guards/Vk-auth.guard");
const Google_auth_guard_1 = require("./utils/guards/Google-auth.guard");
let AuthController = class AuthController {
    ...
    googleRedirect(request) {
        return request.user;
    }
    async vkontakteLogin() {
        return { msg: "vk" };
    }
    async vkontakteCallback(request) {
        return request.user;
    }
};
__decorate([
...
__decorate([
    (0, common_1.Get)("vkontakte"),
    (0, common_1.UseGuards)(Vk_auth_guard_1.VkAuthGuard),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "vkontakteLogin", null);
__decorate([
    (0, common_1.Get)("vkontakte/callback"),
    (0, common_1.UseGuards)(Vk_auth_guard_1.VkAuthGuard),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "vkontakteCallback", null);
